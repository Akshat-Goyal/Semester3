...
String apiKey = "29NLXUYZLYSV1DPG";  
...
void setup()
{
  //defining input pins to read sensor values
  pinMode(32, INPUT);
  pinMode(33, INPUT);
  pinMode(34, INPUT);
  pinMode(35, INPUT);
...
void loop()
{
  ...
  //read analog inputs from four pins corresponding to four soil moisture sensors.
  ...
  //concatenating string with measured values to send data to server.
  String ADCData;
